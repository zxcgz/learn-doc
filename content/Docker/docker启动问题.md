...
可以尝试删除docker网络`sudo rm -rf /var/lib/docker/network`

这是由于docker在底层操作了iptable，绕过了firewalld，在docker容器中映射的端口不要在firewall中再次添加，可能会导致docker容器无法启动或者docker服务无法启动